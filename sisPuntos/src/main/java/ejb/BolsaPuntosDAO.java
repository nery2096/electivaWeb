...
public class BolsaPuntosDAO extends AbstractFacade<BolsaPuntos> {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    public List<BolsaPuntos> findPuntosPorRango(@PathParam("from") Integer from,@PathParam("to") Integer to){
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    public List<BolsaPuntos> bolsaPorCliente(@PathParam("idCliente") Integer idCliente) {
