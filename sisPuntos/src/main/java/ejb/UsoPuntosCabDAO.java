...
public class UsoPuntosCabDAO extends AbstractFacade<UsoPuntosCab> {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    public List<UsoPuntosCab> findUsoClientes(@PathParam("idCliente") Integer idCliente){
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    public List<UsoPuntosCab> findUsoConcepto(@PathParam("idConcepto") Integer idConcepto){
